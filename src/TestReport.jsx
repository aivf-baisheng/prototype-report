      ...
      <nav className="navigation-sidebar">
        <div className="nav-content">
          <svg className="nav-icon" width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path d="M2 5.99998L8 1.33331L14 5.99998V13.3333C14 13.6869 13.8595 14.0261 13.6095 14.2761C13.3594 14.5262 13.0203 14.6666 12.6667 14.6666H3.33333C2.97971 14.6666 2.64057 14.5262 2.39052 14.2761C2.14048 14.0261 2 13.6869 2 13.3333V5.99998Z" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M6 14.6667V8H10V14.6667" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          <svg className="nav-icon" width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path d="M2 2V5.33333H5.33333" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M2.03333 8.66665C2.181 10.0039 2.7738 11.2526 3.71652 12.2124C4.65924 13.1722 5.89718 13.7874 7.23153 13.959C8.56587 14.1307 9.91919 13.8489 11.0741 13.159C12.2291 12.469 13.1187 11.4109 13.6 10.1546C14.0813 8.89832 14.1264 7.51672 13.7281 6.23169C13.3298 4.94666 12.5112 3.83278 11.4037 3.06894C10.2962 2.30509 8.96419 1.93561 7.62148 2.01983C6.27878 2.10405 5.00334 2.63708 4 3.53331L2 5.33331" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M8 4.66669V8.00002L10.6667 9.33335" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          <svg className="nav-icon" width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path d="M10 1.33331H6.00001C5.63182 1.33331 5.33334 1.63179 5.33334 1.99998V3.33331C5.33334 3.7015 5.63182 3.99998 6.00001 3.99998H10C10.3682 3.99998 10.6667 3.7015 10.6667 3.33331V1.99998C10.6667 1.63179 10.3682 1.33331 10 1.33331Z" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M10.6667 2.66669H12C12.3536 2.66669 12.6927 2.80716 12.9428 3.05721C13.1928 3.30726 13.3333 3.6464 13.3333 4.00002V13.3334C13.3333 13.687 13.1928 14.0261 12.9428 14.2762C12.6927 14.5262 12.3536 14.6667 12 14.6667H3.99999C3.64637 14.6667 3.30723 14.5262 3.05718 14.2762C2.80713 14.0261 2.66666 13.687 2.66666 13.3334V4.00002C2.66666 3.6464 2.80713 3.30726 3.05718 3.05721C3.30723 2.80716 3.64637 2.66669 3.99999 2.66669H5.33332" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M8 7.33331H10.6667" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M8 10.6667H10.6667" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M5.33334 7.33331H5.34001" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M5.33334 10.6667H5.34001" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          <svg className="nav-icon" width="16" height="16" viewBox="0 0 16 16" fill="none">
            <path d="M13.3333 4.66669H7.33334" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M9.33334 11.3333H3.33334" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M11.3333 13.3333C12.4379 13.3333 13.3333 12.4379 13.3333 11.3333C13.3333 10.2287 12.4379 9.33331 11.3333 9.33331C10.2288 9.33331 9.33334 10.2287 9.33334 11.3333C9.33334 12.4379 10.2288 13.3333 11.3333 13.3333Z" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M4.66666 6.66669C5.77123 6.66669 6.66666 5.77126 6.66666 4.66669C6.66666 3.56212 5.77123 2.66669 4.66666 2.66669C3.56209 2.66669 2.66666 3.56212 2.66666 4.66669C2.66666 5.77126 3.56209 6.66669 4.66666 6.66669Z" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          <svg className="nav-icon" width="16" height="16" viewBox="0 0 16 16" fill="none">
            <g clipPath="url(#clip0_1_515)">
              <path d="M12 5.33331C12 4.27245 11.5786 3.25503 10.8284 2.50489C10.0783 1.75474 9.06087 1.33331 8 1.33331C6.93913 1.33331 5.92172 1.75474 5.17157 2.50489C4.42143 3.25503 4 4.27245 4 5.33331C4 9.99998 2 11.3333 2 11.3333H14C14 11.3333 12 9.99998 12 5.33331Z" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M9.15335 14C9.03614 14.2021 8.86791 14.3698 8.6655 14.4864C8.46309 14.6029 8.2336 14.6643 8.00001 14.6643C7.76643 14.6643 7.53694 14.6029 7.33453 14.4864C7.13212 14.3698 6.96389 14.2021 6.84668 14" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M1.33334 5.33331C1.33334 3.86665 1.80001 2.46665 2.66668 1.33331" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M14.6667 5.33331C14.6667 3.89084 14.1988 2.48729 13.3333 1.33331" stroke="#475569" strokeLinecap="round" strokeLinejoin="round"/>
            </g>
            <defs>
                  ...
                  bundle.recipes.map((recipe) =>
                    recipe.prompts.map((prompt, promptIndex) => (
                      <div key={`${bundle.name}-${recipe.name}-${promptIndex}`} 
                        ...
                        <div className="table-cell notes-text">{prompt.notes}</div>
                      </div>
                    ))
                  )
                )
